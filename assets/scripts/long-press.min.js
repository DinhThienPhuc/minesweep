...
!(function (e, t) {
  ...
  function l(e) {
    ...
    d(),
      (n = e),
      (e = a && n.touches && n.touches[0] ? n.touches[0] : n),
      this.dispatchEvent(
  ...
  "function" != typeof e.CustomEvent &&
    ...
    t.addEventListener(o, d, !0),
    t.addEventListener(
      m,
      function (e) {
        var t = Math.abs(r - e.clientX),
          n = Math.abs(u - e.clientY);
        (t >= s || n >= c) && d();
      },
      !0
    ),
    t.addEventListener("wheel", d, !0),
    t.addEventListener("scroll", d, !0),
    t.addEventListener(
      i,
      function (e) {
        (r = e.clientX), (u = e.clientY), v(e);
      },
      !0
    );
})(window, document);
